...
> 属性刻印:(属性番号)の文字列で登録済み
> 属性刻印名(属性番号, 対象キャラ)でキャラを指定しての属性刻印名取得も可能。 
> こちらの場合、属性番号の引数が0～6の範囲内に無くてもエラーが出ない…はず。

* カリオストロの奥義・アビを強化。固有サポアビを追加 
> 原作の各バージョンのを適当に混ぜ混ぜ。刻印キャラの見本の意味も。  
